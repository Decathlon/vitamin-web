  ...
  function showSnackbar(snackbar) {
    ...
    if (snackbar === 'vtmn-snackbar-1') {
      document.body.lastChild.innerHTML =
        '<div id="vtmn-snackbar-1" class="vtmn-snackbar"><div class="vtmn-snackbar_content">This is the description of a snackbar<button id="btn-dismiss" class="vtmn-btn vtmn-btn_variant--secondary vtmn-btn_size--small">Button</button></div></div>';
